    ...
    return (
        <section className="flex flex-col lg:flex lg:flex-row w-full justify-center items-center mt-20">
            <div className="flex flex-col-reverse lg:flex-row lg:w-9/12 w-full justify-between">
                <section className="flex flex-col lg:w-7/10 w-full pl-8 lg:pl-2 space-y-10 mt-10 md:mt-0">
                    ...
                    <p className="text-2xl text-[#8A8A8A] text-justify w-19/20">
                    ...
                    <Link href="https://drive.google.com/file/d/1zqeznKAg8Wx8Co3Bcr-5dENGajcV3lFQ/view?usp=sharing" target="_blank">
                        <button className="font-bold text-[16px] text-gray-secondary border border-black-primary p-5 rounded-md lg:w-3/12 w-3/5">Download CV</button>
                    </Link>
                </section>
                <section className="flex flex-col lg:w-1/2 w-full lg:items-end items-center justify-center lg:space-y-2 space-y-6">
                    <ThemeSwitch/>
