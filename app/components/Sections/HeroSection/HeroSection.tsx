...
const HeroSection = () => {
    return (
        ...
        <h1 className="bg-gradient-to-r from-[#E9E9E9] to-[#515151] text-transparent bg-clip-text lg:text-8xl text-6xl font-bold">Building digital products, brands, and experience.</h1>
